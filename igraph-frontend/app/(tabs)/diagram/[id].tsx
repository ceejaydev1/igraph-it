...
const SHAPES_BY_TITLE: Record<string, ShapeUsed[]> = {
  ...
  'Flowchart': [
    ...
    { name: 'Merge', description: 'A small point where two or more flow lines converge back into one.', svgComponent: 'MergeJunctionShape' },
  ...
  'Use Case Diagram': [
    ...
    { name: 'Database', description: 'A cylinder representing data storage a use case reads from or writes to.', svgComponent: 'CylinderShape' },
  ...
  'Class Diagram': [
    ...
    { name: 'Realization', description: 'A dashed arrow with a hollow triangle head, showing a class implementing the behavior an interface promises.', svgComponent: 'UMLRealizationShape' },
    { name: 'Note', description: 'A box for attaching a comment or clarification to the diagram.', svgComponent: 'UMLNoteShape' },
